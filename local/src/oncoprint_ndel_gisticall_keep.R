...
op <- oncoPrint(mat2, alter_fun = alter_fun, col = col, row_order = names(su), column_order=wf$smodel,
                remove_empty_columns = FALSE, remove_empty_rows = FALSE, column_names_gp=gpar(fontsize=8),
...
op3 <- oncoPrint(mat2, alter_fun = alter_fun, col = col, row_order = names(su), column_order=wf$smodel,
