...
largerSize <- (size + 2) * death_conversion_dpi96
...
ci <- cor.test(data$IC50_Irinotecan, data$POLD1)
...
ggsave(p, file="~/dramma.svg", width=89*(death_conversion_dpi96), height=89*(death_conversion_dpi96), units="mm")


# TODO xslx for MarcoA
