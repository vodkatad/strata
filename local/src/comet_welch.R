...
onestat <- function(mod, data) {
  ...
  wmock <- t.test(x=plvx[plvx$treatment=='Untreated', 'circularity'], plvx[plvx$treatment=='Treated', 'circularity'], alternative="greater")
  wrad <- t.test(x=prad51[prad51$treatment=='Untreated', 'circularity'], prad51[prad51$treatment=='Treated', 'circularity'], alternative="greater")
...
t.test(deltas[1,], deltas[2,], alternative='greater')
sink()
